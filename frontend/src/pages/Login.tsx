...
export default function Login() {
  ...
  return (
    <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', minHeight: '100vh', background: 'var(--bg-base)' }}>
      ...
      {/* ERROR SNACKBAR */}
      {error && (
        <div style={{ position: 'fixed', bottom: 20, right: 20, background: 'var(--error)', padding: '1rem', borderRadius: '8px', zIndex: 1000, color: 'white', display: 'flex', justifyContent: 'space-between', gap: '1rem' }}>
          <span>{error}</span>
