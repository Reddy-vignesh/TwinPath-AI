...
files_to_update = [
    ...
    "frontend/src/pages/TwinVisualizer.tsx",
    "frontend/src/pages/SalaryPredictions.tsx"
]
...
for rel_path in files_to_update:
    ...
    data = json.dumps({
        "message": f"Fix 0% completeness onboarding prompts across all pages in {filename}",
        "content": content,
        "sha": sha
    }).encode('utf-8')
